...
class AnimatedHeader extends Component {
  ...
  renderHeaderBackground() {
    const { backgroundImage, backgroundColor,renderLowerContent } = this.props;
    const imageOpacity = this.getImageOpacity();
    const lowerOpacity = this.getLowerOpacity();
    return (
      <Animated.View
        style={[
          styles.header,
      ...
      >
        ...
        <Animated.View style={{width:'90%',height:100,position:'absolute',bottom:0,left:20,opacity:lowerOpacity}}>
          {renderLowerContent}
        </Animated.View>
      </Animated.View>
    );
  ...
  renderHeaderTitle() {
    ...
    const titleTranslateX = this.getTitleTranslateX();
    ...
    return (
      ...
      >
        {typeof title === 'string'
          && (
            <Animated.Text style={[styles.headerText, titleStyle, {fontSize:16}]}>
              {title}
            </Animated.Text>
          )
        }
...
AnimatedHeader.propTypes = {
  ...
  renderLowerContent:PropTypes.func,
