package com.ydcrackerpackages.compressor;
...
public class Compressor {
    ...
    public Compressor(Context context, String destinationDirectoryPath) {
    ...
    public Compressor setDestinationDirectoryPath() {
        this.destinationDirectoryPath = destinationDirectoryPath;
        return this;
    }
