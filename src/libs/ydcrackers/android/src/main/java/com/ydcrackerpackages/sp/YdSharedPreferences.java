package com.ydcrackerpackages.sp;
...
public class YdSharedPreferences extends ReactContextBaseJavaModule {
	...
	public YdSharedPreferences(ReactApplicationContext reactContext) {
		super(reactContext);
	}
