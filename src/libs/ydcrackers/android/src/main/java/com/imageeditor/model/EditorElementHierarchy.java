...
import com.imageeditor.renderers.CropAreaRenderer;
import com.imageeditor.renderers.InverseFillRenderer;
import com.imageeditor.renderers.OvalGuideRenderer;
...
final class EditorElementHierarchy {
  ...
  static @NonNull EditorElementHierarchy create() {
    return new EditorElementHierarchy(createRoot(0));
  }

  static @NonNull EditorElementHierarchy createForCircleEditing() {
    return new EditorElementHierarchy(createRoot(1));
  }

  static @NonNull EditorElementHierarchy createForReactEditing() {
    return new EditorElementHierarchy(createRoot(2));
  }
  ...
  private static @NonNull EditorElement createRoot(int editMode) {
    ...
    EditorElement cropEditorElement = new EditorElement(new CropAreaRenderer(R.color.crop_area_renderer_outer_color, editMode == 0));
    ...
    cropEditorElement.addElement(createThumbs(cropEditorElement, editMode == 0));
