package com.vydia.RNUploader.events;

import android.app.PendingIntent;
import android.widget.Toast;
import android.content.Context;
import android.content.Intent;
import com.vydia.RNUploader.events.NotificationActionsReceiver;
...
public class NotificationActions {        
    public static String INTENT_ACTION = "com.vydia.RNUploader.events.notification.action";
